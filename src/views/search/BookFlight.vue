<template>
    <div class="book-flight">
                ...
                <div class="step-one" v-show="currentStep == 2">
                    ...
                    <div v-show="sendData.payment == '1'" class="spacer"></div>
                    <div v-show="sendData.payment == '1'" class="score">
                        <cButton
    ...
    export default {
        ...
        mounted() {
            ...
            this.$store.dispatch('service_search/' + types.A_GET_MANAGERS)
                .then(res => {
                    this.managers = this.$store.state.service_search.company_managers;
                })
        ...
        methods: {
            printPayment() {
                console.log(222)
              this.$store.dispatch("service_search/" + types.A_PRINT_PAYMENT, this.flightData.flightplaces.ow)
            },
            nextStep() {
                let valid = true;
