<template>
    <div class="fees-add-content">
        <div class="fees-add-header">
            <div class="headline">
                <h5>{{($route.params.id) ? 'Редактирование' : 'Добавление'}} авиасбора</h5>
            </div>
                ...
                <div class="grouping">
                    <div class="paragraph pl-2 pr-2">
                        ...
                        <cInput
                                ...
                                v-model.trim="$v.feesParam.size_fees_inscribed.$model"
                ...
                <div class="grouping">
                    <div class="paragraph pl-2 pr-2">
                        ...
                        <cInput
                                ...
                                v-model.trim="$v.feesParam.size_fees_charge.$model"
                                inputPadding="9px 10px"
                        ></cInput>
            ...
            <div class="paragraph-wrap">
                ...
                <div class="grouping">
                    <div class="paragraph pl-2 pr-2">
                        ...
                        <cInput
                                ...
                                v-model.trim="$v.feesParam.size_fees_exchange.$model"
                                inputPadding="9px 10px"
                        ></cInput>
                ...
                <div class="paragraph pl-2 pr-2">
                    ...
                    <cInput
                            ...
                            v-model.trim="$v.feesParam.size_deviation.$model"
                            inputPadding="9px 10px"
                    ></cInput>
    ...
    export default {
        ...
        mounted() {
            ...
            if(this.$route.params.id) {
                ...
                let data = this.$store.getters['controls/getFeesById'](this.$route.params.id);
        ...
        computed: {
            getAirlines(){
                if(this.$store.getters['controls/getfeesData'] != null) {
                    return this.$store.getters['controls/getfeesData'].airlines;
                }
                return [];
            },
            getFarefamilies(){
                if(this.$store.getters['controls/getfeesData'] != null) {
                    return this.$store.getters['controls/getfeesData'].farefamilies;
                }
                else {
                    return [];
                }
        ...
        methods: {
            submit() {
                ...
                if (!this.$v.$invalid) {
                    if(this.$route.params.id) {
                        this.feesParam.feeplace_id = this.$route.params.id;
