        ...
        watch: {
            checkSend(val) {
                ...
                this.$store.dispatch("service_search/" + types.A_SAVE_SEND_DATA_PASSENGERS, data)
                    .then(res => {
                        this.$store.dispatch("service_search/" + types.A_BOOKING, this.$store.state.service_search.sendData)
                            .then(result => {
