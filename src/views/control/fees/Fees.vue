<template>
    <div class="fees-content">
        <div class="headline">
            <h3 class="headline-text">Сборы компании</h3>
        </div>
        ...
        <div class="table-wrap">
            ...
            >
                ...
                <template slot="items" scope="props">
                        ...
                        <td @click="editFees(props.item.id)">{{getType(props.item.types_fees_id)}}</td>
                        ...
                        <td @click="editFees(props.item.id)">{{props.item.size_fees_inscribed}}&#8381;</td>
                        <td @click="editFees(props.item.id)">{{props.item.size_fees_charge}}&#8381;</td>
                        <td @click="editFees(props.item.id)">{{props.item.size_deviation}}&#8381;</td>
                </template>
            </v-data-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            editFees(id) {
                this.$router.push('/control/fees/add/' + id)
            },
            getClass(classId) {
